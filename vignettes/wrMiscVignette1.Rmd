...
The function  `stableMode()` presented here has different modes of operation, at tis point there are no clear rules which mode may perform most satisfactory on different data.
