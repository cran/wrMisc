...
The function `combineRedundLinesInListAcRef()` provides help for combining/summarizing lines of numeric data which may be summaried according to reference vector or matrix (part of the same input-list).
