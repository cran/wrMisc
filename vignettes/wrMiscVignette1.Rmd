...
Sometimes one need to get the coordinates of values/points of a matrix according to a given filtering condition.
...
If you need to know the true row/column indexes, you may use _coordOfFilt()_.
