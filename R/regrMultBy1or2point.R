...
#'
#' This function regresses each col of matrix according to 'refLst'(describing rownames of inDat). 
...
#'
#' @param inDat (matrix or data.frame) data to be rescaled
...
#' @export
regrMultBy1or2point <- function(inDat, refLst, regrTo=c(1,0.5), silent=FALSE, debug=FALSE, callFrom=NULL){
