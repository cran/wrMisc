...
#' @return matrix containing both selected columns plus additional column(s) indicating group-number of the pair-wise combination 
...
#' @export
combineByEitherFactor <- function(mat,refC1,refC2,nByGrp=FALSE,convergeMax=TRUE,callFrom=NULL,silent=FALSE) {
