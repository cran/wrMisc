...
#' @return This function returns a (numeric) matrix with 2 columns (eg from initial concatenated coordinates) 
...
#' @export
extractLast2numericParts <- function(x, silent=FALSE, debug=FALSE, callFrom=NULL) {
