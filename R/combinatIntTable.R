...
#'
#' This function provides all combinations for each of n elements of vector 'nMax' (positive integer, eg number of max multiplicative value). 
...
#' @param callFrom (character) allow easier tracking of messages produced d
#' @return This function retruns a list or array (as 2- or 3 dim) with possible number of occurances for each of the 3 elements in nMax. Read results vertical : out[[1]] or out[,,1] .. (multiplicative) table for 1st element of nMax; out[,,2] .. for 2nd
