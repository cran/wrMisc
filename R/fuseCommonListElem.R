...
#' @return  This function returns a fused list (same names as elements of input)
...
#' @export
fuseCommonListElem <- function(lst, initOrd=TRUE, removeDuplicates=FALSE, silent=FALSE, debug=FALSE, callFrom=NULL) {
