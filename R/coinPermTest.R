...
#' @export
coinPermTest <- function(x1, x2, orient="two.sided", nPerm=5000, silent=FALSE, debug=FALSE, callFrom=NULL){
  ...
  if(requireNamespace("coin", quietly=TRUE)) {
    ...
    if(!silent) message(fxNa,"Package 'coin' not found, please install from CRAN; returning NULL")
  }     
}
