...
Now we can obtain the CV (coefficient of variance) by splitting along 3rd dimesion (ie this is equivalent to an _apply_ alon the 3rd dimension) using `arrayCV`:
